...
if audio_files:
    ...
    print("combined pred: ", combined_predicted_transcriptions[:1000] )
    print("combined corr: ", combined_correct_transcriptions[:1000])

    print("combined child pred: ", predicted_transcriptions_by_person['child'][:800])
    print("combined child corr: ", correct_transcriptions_by_person['child'][:800])

    print("combined adult pred: ", predicted_transcriptions_by_person['psych'][:800])
    print("combined adult corr: ", correct_transcriptions_by_person['psych'][:800])
